if(!dojo._hasResource["capuchn.TitlePane"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["capuchn.TitlePane"] = true;
dojo.provide("capuchn.TitlePane");
